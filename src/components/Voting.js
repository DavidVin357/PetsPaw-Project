...
class Voting extends React.Component {
  constructor(props) {
    super(props)
    this.state = { checkedFav: false }
    this.emotionsRef = React.createRef()
  }
  ...
  componentDidMount() {
    ...
    this.props.getVotingHeight(height)
  }
  render() {
    return (
      <div
      ...
      >
        <button id='like' onClick={this.props.addLike}>
          <svg
            width='30'
            height='30'
            viewBox='0 0 30 30'
        ...
        <button
          ...
          onClick={() => {
            ...
            checkedFav ? this.props.removeFav() : this.props.addFav()
        ...
        <button id='dislike' onClick={this.props.addDislike}>
          <svg
            width='30'
            height='30'
            viewBox='0 0 30 30'
